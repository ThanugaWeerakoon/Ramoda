...
// Filter out Dress products
const menProducts = productsData.filter(product => product.isDress);
        ...
        >
          <div className="relative overflow-hidden">
            <img
              src={product.image}
              alt={product.name}
              className="w-full h-200 object-cover transform transition-transform duration-300 hover:scale-105"
            />
          </div>
