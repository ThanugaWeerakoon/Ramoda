...
const Contact = () => {
 ...
 {/* **************************************************************************form****************************************************************************** */}
      ...
      <div className="text-center text-black-400 mt-10">
        ...
        <ul class="flex items-center justify-center space-x-14 pt-10 h-[76px] w-full font-sans">
            <li class="relative flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg cursor-pointer transition-transform duration-300 ease-in-out hover:scale-125 hover:shadow-xl group">
                
                <svg class="w-6 h-6 fill-current text-blue-600 " viewBox="0 0 320 512" height="1.2em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
                </svg>
            </li>

            <li class="relative flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg cursor-pointer transition-transform duration-300 ease-in-out hover:scale-125 hover:shadow-xl group">
                <svg class="w-7 h-7 fill-current text-blue-500" viewBox="0 0 48 48" height="1.8em" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg cursor-pointer transition-transform duration-300 ease-in-out hover:scale-125 hover:shadow-xl group">
                <svg class="w-6 h-6 fill-current text-pink-600 " xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 16 16">
      ...
      <h1 className="text-3xl font-semibold text-center text-black-800 mb-12 mt-10">
